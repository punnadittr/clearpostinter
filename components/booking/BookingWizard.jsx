...
export default function BookingWizard({ onCancel }) {
    ...
    return (
        <div className="bg-white rounded-3xl shadow-2xl shadow-slate-200/50 overflow-hidden border border-slate-100 max-w-2xl mx-auto">
            {/* Header */}
            <div className="bg-white px-8 py-6 border-b border-slate-100 flex justify-between items-center">
                <div>
                    <h3 className="text-xl font-bold text-slate-900">Select Appointment</h3>
                    <p className="text-sm text-slate-500 mt-1">For identity verification video call</p>
                </div>
                                ...
                                {dates.map((date) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`flex-shrink-0 w-[5.5rem] py-4 rounded-2xl border transition-all duration-200 group relative overflow-hidden ${isSelected
                                        ...
                                        >
                                            <div className={`text-[11px] font-bold uppercase tracking-wider mb-1 ${isSelected ? 'text-slate-300' : 'text-slate-400'}`}>
                                                {format(date, 'EEE')}
                                            </div>
                                            <div className={`text-2xl font-bold mb-1 ${isSelected ? 'text-white' : 'text-slate-900'}`}>
                                                {format(date, 'd')}
                                            </div>
                                ...
                                <div className="grid grid-cols-3 sm:grid-cols-4 gap-3">
                                    {availableSlots.map((slot) => (
                                        <button
                                            ...
                                            className={`py-3 px-2 rounded-xl text-sm font-semibold border transition-all duration-200 ${!slot.available
                    ...
                    <div className="space-y-8 animate-in slide-in-from-right-8 duration-300">
                        ...
                        <div className="bg-slate-900 rounded-2xl p-6 text-white shadow-xl shadow-slate-900/10 relative overflow-hidden">
                            <div className="relative z-10 flex items-start gap-4">
                                ...
                                <div>
                                    <p className="text-blue-200 text-sm font-medium mb-1">Passpost Verification</p>
                        ...
                        <div className="space-y-5">
                            <div className="space-y-1.5">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-12 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all text-slate-900 font-medium placeholder:text-slate-400"
                                        value={formData.name}
                            ...
                            <div className="space-y-1.5">
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all text-slate-900 font-medium placeholder:text-slate-400"
                        ...
                        <button
                            ...
                            className="w-full py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold text-lg shadow-lg shadow-blue-600/30 flex items-center justify-center gap-3 disabled:opacity-50 disabled:shadow-none transition-all transform active:scale-[0.98]"
                        >
                            {isSubmitting ? (
